    ...
    <div className="settings">
      ...
      <div className="settings-scroll">
        ...
        <section className="settings-section">
          ...
          {pro ? (
            <button className="settings-item" onClick={manageSubscription}>
              <span className="si-ico">💳</span>
              <div className="si-body">
                <div className="si-title">Manage subscription</div>
                <div className="si-sub">Update payment or cancel in the billing portal</div>
              </div>
              <span className="si-chev">›</span>
            </button>
          ) : (
            <button className="settings-item accent" onClick={onUpgrade}>
              <span className="si-ico">✨</span>
              <div className="si-body">
                <div className="si-title">Upgrade to SnapGut Pro</div>
                <div className="si-sub">Unlimited AI recognition & insights</div>
              </div>
              <span className="si-chev">›</span>
            </button>
          )}
        ...
        <section className="settings-section">
          ...
          <button className="settings-item" onClick={doBackup}>
            <span className="si-ico">⬆️</span>
            <div className="si-body">
              <div className="si-title">Back up data</div>
              <div className="si-sub">Save a full backup (with photos) to Files/iCloud</div>
            </div>
            <span className="si-chev">›</span>
          </button>
          <button className="settings-item" onClick={() => fileRef.current?.click()}>
            <span className="si-ico">⬇️</span>
            <div className="si-body">
              <div className="si-title">Restore from backup</div>
              <div className="si-sub">Import a backup file — merges into your log</div>
            </div>
            <span className="si-chev">›</span>
          </button>
          <button className="settings-item" onClick={exportCSV}>
            <span className="si-ico">📄</span>
            <div className="si-body">
              <div className="si-title">Export as CSV</div>
              <div className="si-sub">Spreadsheet of your timeline</div>
            </div>
            <span className="si-chev">›</span>
          </button>
        </section>
        ...
        <section className="settings-section">
          <button className="settings-item" onClick={signOut}>
            <span className="si-ico">🚪</span>
            <div className="si-body">
              <div className="si-title">Sign out</div>
              <div className="si-sub">Your logs stay on this device</div>
            </div>
          </button>
          <button className="settings-item danger" onClick={() => setConfirmDelete(true)}>
            <span className="si-ico">🗑️</span>
            <div className="si-body">
              <div className="si-title">Delete account & data</div>
              <div className="si-sub">Removes your account and wipes this device</div>
            </div>
          </button>
        </section>
