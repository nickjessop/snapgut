...
community leaders responsible for enforcement by opening an issue in this repository. If the
report is sensitive or naming the people involved in public would make things worse, use one of
the private channels instead:

* GitHub's [report abuse](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam)
  flow, which reaches GitHub Support directly.
...
volunteer-maintained project, so "promptly" means as soon as a maintainer is available rather
than within a guaranteed window.
